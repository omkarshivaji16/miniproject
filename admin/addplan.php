...
$qs=mysqli_query($con,"insert into addplan(cname,plan) values('$n','$p')");
...
<center>                        
      ...
      <tr>
        ...
        <td>CHOOSE GARBAGE CATEGORY</td><td><select name="cname">
         ...
         <tr><td>ADD PLAN:</td><td><input type="text" name="pl"></td></tr> 
