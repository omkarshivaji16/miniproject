        ...
        <div class="row">
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="pri_table_list">
              <h3>SILVER PLAN</span></h3>
              <ol>
                <li class="check"><i class="bi bi-check"></i><span>SILVER MEMBER</span></li>
                <li class="check"><i class="bi bi-check"></i><span>Charge:500 to 1000</span></li>
                <li class="check"><i class="bi bi-check"></i><span>validity:3 month</span></li>
               
                <li class="cross"><i class="bi bi-x"></i><span>ServiceCharge: Applicable</span></li>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="pri_table_list active">
              <span class="saleon"></span>
              <h3>GOLDEN PLAN</span></h3>
              <ol>
                <li class="check"><i class="bi bi-check"></i><span>GOLDEN MEMBER</span></li>
                <li class="check"><i class="bi bi-check"></i><span>Charge:1000 to 3000</span></li>
                <li class="check"><i class="bi bi-check"></i><span>validity:8 month</span></li>
                <li class="check"><i class="bi bi-check"></i><span>ServiceCharge:Applicable</span></li>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="pri_table_list">
              <h3>DIAMOND PLAN</span></h3>
              <ol>
                <li class="check"><i class="bi bi-check"></i><span>GOLDEN MEMBER</span></li>
                <li class="check"><i class="bi bi-check"></i><span>Charge:3000 to 5000</span></li>
                <li class="check"><i class="bi bi-check"></i><span>validity:1 YEAR</span></li>
                <li class="check"><i class="bi bi-check"></i>
                  <span>ServiceCharge: Applicable</span></li>
