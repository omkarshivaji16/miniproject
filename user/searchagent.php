  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="Userhome">Home</a></li>
      ...
      <h2>AGENCY LISTS</h2>
            ...
            <thead>
              ...
              <th>LOCATION</th>
                                                        ...
                                                        <th>CATEGORY</th>
                                                        <th style="color:red">COLLECTINGGADGET</th>
                                                        <th>EMAIL</th>
                                                        <th>ACTION</th>
            ...
            <tbody>
              <?php
                                                  ...
                                                  $qr="select  * from agentreg where catname='$category' order by id asc";
  ...
  <td style="color:white"><?php echo $r['name'];?></td>
     ...
     <td  style="color:white"><?php echo $r['agenname'];?></td>
        <td  style="color:white"><?php echo $r['catname'];?></td> 
         <td  style="color:white"><?php echo $r['gad'];?></td> 
