...
<head>
  ...
  <title>E-Waste Collection Portal - User</title>
...
table th, table td {
 ...
 <center><h1 style="color:white">ADMIN REPLY</h1>
  ...
  <div class="w3-table-info" style="margin-left:-320px;overflow-x:auto; ">                 
      ...
      <table id="table" >
           ...
           <th>ADMIN REPLY</th>
            ...
            <?php
             $query1=  mysqli_query($con,"select * from addfeedback where uid=".$_SESSION['user']['uid']);
            ...
            <tr>
               ...
               <td style="color:white"><?php echo $r['comment'];?></td>
               <td style="color:white"><?php echo $r['reply'];?></td>
