...
table th, table td {
 ...
 <center><h1 style="color:white">LIST OF USERS</h1>
  ...
  <div class="w3-table-info" style="margin-left:-320px;overflow-x:auto; ">                 
      ...
      <table id="table" >
           ...
           <th colspan="2">ACTIONS</th>
            ...
            <?php
             $query1=  mysqli_query($con,"select * from bookagency where agid=".$_SESSION['agent']['id']);
                ...
                <td style="color:white"><?php echo $r['email'];?></td>
                 <td style="color:white"><?php echo $r['wastetype'];?></td>
                  ...
                  <td style="color:white"><?php echo $r['amount'];?></td>
                    <td style="color:white"><?php echo $r['status'];?></td>

             <td><a class="btn btn-primary" href="accepts.php?id=<?php echo $r["bookid"];?>" style="color:black">ACCEPT</a></td>
            <td><a class="btn btn-info" href="rejects.php?id=<?php echo $r["bookid"];?>" style="color:black">REJECT</a></td>
